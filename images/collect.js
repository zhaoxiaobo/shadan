	...
	function get_total_price(){
		var jiage_200ip= $('#jiage_200ip').val()/2;
		var jiage_600ip= $('#jiage_600ip').val()/2;
		var jiage_1000ip= $('#jiage_1000ip').val()/2;
		var jiage_2000ip= $('#jiage_2000ip').val()/2;
		var jiage_6000ip= $('#jiage_6000ip').val()/2;
		var jiage_10000ip= $('#jiage_10000ip').val()/2;
		var jiage_30000ip= $('#jiage_30000ip').val()/2;
		
		var ips_arr= new Array(new Array('200',jiage_200ip),new Array('600',jiage_600ip),new Array('1000',jiage_1000ip),new Array('2000',jiage_2000ip),new Array('6000',jiage_6000ip),new Array('10000',jiage_10000ip),new Array('30000',jiage_30000ip));
...
{  
	...
	function cs_count_collect(){
		var nums= $('#nums').val();
		var shouchangjiage= $('#shouchangjiage').val();
		if (!isMatch(/^\d+$/, nums)){
			$('#nums').val('');
		}
		else{
			total_price=format_money(nums*shouchangjiage);
