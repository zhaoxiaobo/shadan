...
function preselect(p_key) {
    ...
    var provinces = new Array("北京", "天津", "上海", "重庆", "河北省", "山西省", "内蒙古", "辽宁省", "吉林省", "黑龙江省", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西", "海南省", "四川省", "贵州省", "云南省", "西藏", "陕西省", "甘肃省", "青海省", "宁夏", "新疆", "香港", "澳门", "台湾省");
...
dsy.add("0_19_11", ["莞城区", "南城区", "东城区", "万江区", "石碣镇", "石龙镇", "茶山镇", "石排镇", "企石镇", "横沥镇", "桥头镇", "谢岗镇", "东坑镇", "常平镇", "寮步镇", "大朗镇", "黄江镇", "清溪镇", "塘厦镇", "凤岗镇", "长安镇", "虎门镇", "厚街镇", "沙田镇", "道滘镇", "洪梅镇", "麻涌镇", "中堂镇", "高埗镇", "樟木头镇", "大岭山镇", "望牛墩镇"]);
dsy.add("0_19_12", ["香洲区", "斗门区", "金湾区"]);
dsy.add("0_19_13", ["石岐区", "东区", "西区", "南区", "五桂山区", "火炬高技术产业开发区"]);
...
var s = ["s1", "s2", "s3"];
var opt0 = [" 请选择省份 ", " 地级市 ", " 县/区 "];
function setup() {
    for (i = 1; i <= s.length; i++)
        document.getElementById(s[i-1]).onchange = new Function("promptinfo();change(" + i + ");");
    change(0);
}
