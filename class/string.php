...
class string{
	...
	public static function fun_strtotime($var1=0,$var2=0){
		if(!$var2){
			$var2 = $var1;
			$var1 = 0;
		}
	...
	public static function fun_date($var1=0,$var2=0){
		if(!$var2){
			$var2 = $var1;
			$var1 = 'Y-m-d H:i:s';
		}
	...
	public static function getXin1($str){
		$strLen = mb_strlen($str);
		if ($strLen >= 2) {
			return self::getXin($str, $strLen-1, 1);
		}
		return $str;
	}
