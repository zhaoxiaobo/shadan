...
function kefu_x(a,hash,tit,price){
     comm_fram(413, 205, "请确定购买信息", "", "<form id=qtform action='/user/buycards/' method=post name=myform><div style='height:150px;margin:0px 10px;'><p>"+tit+"</p><p>花费:"+price+"元，你确定购买吗？</p><p>请选择推荐人</p><p><select name='spreader'><option value=''> 无推荐人，自行购买</option></select></p><p style='text-align:right;padding:10px;'><input type='hidden' value="+hash+" name='hash2'><input type=hidden value="+a+" name='card'><input type=hidden value='add' name='type'><input type='submit' class='btn_em' value='确 定'><input onclick='doCut();' class=btn_dft type='button' tabindex='9' value='取 消'></p></div></form>");
}
